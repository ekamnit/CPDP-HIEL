...
data <- rbind(ant1, ant2, ant3, ant4, ant5, camel1, camel2, camel3, camel4,
              jedit1, jedit2, jedit3, jedit4, jedit5,poi1, poi2,
...
# Ploting
##############################################
diverse10 <- c(0.8252,0.8185,0.8452,0.8089,0.8452,0.8452,0.8452,0.8452,0.8452)
diverse20 <- c(0.8045,0.8045,0.8045,0.8045,0.8045,0.8045,0.8045,0.8045,0.8045)
diverse30 <- c(0.8,0.7878,0.8329,0.7878,0.7878,0.7878,0.7878,0.7878,0.7878)
diverse40 <- c(0.8117,0.8089,0.8089,0.8089,0.8089,0.8089,0.8089,0.8089,0.8089)
diverse50 <- c(0.8208,0.8089,0.8089,0.8089,0.8089,0.8089,0.8089,0.8089,0.8089)
diverse60 <- c(0.8421,0.8421,0.8112,0.8,0.8,0.8,0.8,0.8,0.8)

png(file = "Log4j.jpg")
# Plot the bar chart.
plot(diverse10, type = "o",col = "red", xlab = "β Values", ylab = "F-Measure Values",
     ylim=c(0.78,0.85), lwd = 2)
