...
data <- rbind(ant1, ant2, ant3, ant4, ant5, camel1, camel2, camel3, camel4, jedit1, jedit2,
              ...
              poi3, poi4, redaktor, synapse1, synapse2, synapse3, tomcat,
              xalan1, xalan2, xalan3, xalan4, xerces1, xerces2, xerces3)
...
# Ploting
##############################################
diverse10 <- c(0.8088,0.8088,0.8088,0.8088,0.8088,0.8088,0.8088,0.8088,0.8088)
diverse20 <- c(0.7923,0.7836,0.7836,0.7836,0.7836,0.7836,0.7836,0.7836,0.7836)
diverse30 <- c(0.7806,0.7833,0.7756,0.7756,0.7756,0.7756,0.7756,0.7756,0.7756)
diverse40 <- c(0.8088,0.7879,0.7879,0.7879,0.7879,0.7879,0.7879,0.7879,0.7879)
diverse50 <- c(0.8088,0.7967,0.7967,0.7967,0.7967,0.7967,0.7967,0.7967,0.7967)
diverse60 <- c(0.8101,0.7955,0.7911,0.7911,0.7911,0.7911,0.7911,0.7911,0.7911)

png(file = "Velocity.jpg")
# Plot the bar chart.
plot(diverse10, type = "o",col = "red", xlab = "β Values", ylab = "F-Measure Values",
     ylim=c(0.77,0.84), lwd = 2)
