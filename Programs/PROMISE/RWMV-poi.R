...
data <- rbind(ant1, ant2, ant3, ant4, ant5, camel1, camel2, camel3, camel4,
              ...
              log4j1, log4j2, log4j3, redaktor, synapse1, synapse2, synapse3, tomcat, velocity1,
...
# Ploting
##############################################
diverse10 <- c(0.5593,0.5321,0.5593,0.5563,0.5582,0.5582,0.5562,0.5562,0.5562)
diverse20 <- c(0.5328,0.5411,0.4987,0.5367,0.5224,0.5011,0.4969,0.4969,0.4969)
diverse30 <- c(0.5247,0.5502,0.5094,0.5123,0.5457,0.5158,0.5241,0.5219,0.5219)
diverse40 <- c(0.5491,0.5547,0.5491,0.5444,0.5444,0.5386,0.5363,0.5363,0.5363)
diverse50 <- c(0.5572,0.5488,0.5299,0.5269,0.5461,0.5269,0.5269,0.5269,0.5269)
diverse60 <- c(0.5624,0.5576,0.5504,0.5504,0.5583,0.5504,0.5504,0.5504,0.5504)

png(file = "Poi.jpg")
# Plot the bar chart.
plot(diverse10, type = "o",col = "red", xlab = "β Values", ylab = "F-Measure Values",
     ylim=c(0.48,0.6), lwd = 2)
