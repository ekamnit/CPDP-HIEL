...
data <- rbind(ant1, ant2, ant3, ant4, ant5, camel1, camel2, camel3, camel4,
              log4j1, log4j2, log4j3, lucene1, lucene2, lucene3, poi1, poi2, 
...
# Ploting
##############################################
diverse10 <- c(0.7925,0.7925,0.7925,0.7925,0.7929,0.7929,0.7925,0.7925,0.7925)
diverse20 <- c(0.8097,0.8093,0.8063,0.8068,0.8039,0.8039,0.8039,0.8039,0.8039)
diverse30 <- c(0.8612,0.8546,0.8495,0.8354,0.8457,0.8457,0.8329,0.8329,0.8326)
diverse40 <- c(0.8624,0.8469,0.8436,0.8422,0.8436,0.8436,0.8436,0.8436,0.8436)
diverse50 <- c(0.8704,0.8679,0.8664,0.8663,0.8663,0.8663,0.8611,0.8611,0.8611)
diverse60 <- c(0.9033,0.8997,0.8946,0.8896,0.8873,0.8873,0.8873,0.8873,0.8873)

png(file = "JEdit.jpg")
# Plot the bar chart.
plot(diverse10, type = "o",col = "red", xlab = "β Values", ylab = "F-Measure Values",
     ylim=c(0.78,0.94), lwd = 2)
