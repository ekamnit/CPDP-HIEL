...
# Ploting
##############################################
diverse10 <- c(0.8749,	0.8719,	0.871,	0.8723,	0.8676,	0.8679,	0.8679,	0.8649,	0.8649)
diverse20 <- c(0.8897,	0.8829,	0.8829,	0.8829,	0.8829,	0.8829,	0.8829,	0.8829,	0.8829)
diverse30 <- c(0.8745,	0.8659,	0.8655,	0.8652,	0.8744,	0.8744,	0.8744,	0.8744,	0.8837)
diverse40 <- c(0.9023,	0.8837,	0.8808,	0.8785,	0.8785,	0.8785,	0.8785,	0.8785,	0.8785)
diverse50 <- c(0.9129,	0.9042,	0.9012,	0.8899,	0.8899,	0.8899,	0.8899,	0.8899,	0.8899)
diverse60 <- c(0.9321,	0.9147,	0.9143,	0.914,	0.9147,	0.9058,	0.9058,	0.9058,	0.9058)

png(file = "Lucene.jpg")
# Plot the bar chart.
plot(diverse10, type = "o",col = "red", xlab = "β Values", ylab = "F-Measure Values",
     ylim=c(0.85,0.96), lwd = 2)
