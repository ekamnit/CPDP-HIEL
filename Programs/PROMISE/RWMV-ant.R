...
data <- rbind(camel1, camel2, camel3, camel4,
              jedit1, jedit2, jedit3, jedit4, jedit5,
              log4j1, log4j2, log4j3, poi1, poi2, poi3, poi4,
              redaktor, synapse1, synapse2, synapse3, tomcat, velocity1,
...
# Change the target project for its several released versions.
testData <- ant5[,c(-1,-2,-3)]
...
# HIEL
########################################################
# Randomized Weighted Majority Voting implementation
########################################################
