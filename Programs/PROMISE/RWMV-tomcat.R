...
data <- rbind(ant1, ant2, ant3, ant4, ant5, camel1, camel2, camel3, camel4, jedit1,
              ...
              poi3, poi4, redaktor, synapse1, synapse2, synapse3, velocity1,
...
# Ploting
##############################################
diverse10 <- c(0.8656,0.8643,0.8656,0.8648,0.8641,0.8641,0.8641,0.8601,0.8601)
diverse20 <- c(0.8675,0.8666,0.8648,0.8662,0.8616,0.8616,0.8616,0.8616,0.8616)
diverse30 <- c(0.8518,0.8487,0.8463,0.8463,0.8469,0.8463,0.8449,0.8463,0.8463)
diverse40 <- c(0.8702,0.8637,0.8633,0.8631,0.8631,0.8631,0.8631,0.8631,0.8631)
diverse50 <- c(0.8781,0.8689,0.8658,0.8722,0.8728,0.8675,0.8529,0.8616,0.8616)
diverse60 <- c(0.8827,0.8802,0.885,0.8789,0.8785,0.88,0.8794,0.8807,0.8792)

png(file = "Tomcat.jpg")
# Plot the bar chart.
plot(diverse10, type = "o",col = "red", xlab = "β Values", ylab = "F-Measure Values",
     ylim=c(0.84,0.9), lwd = 2)
