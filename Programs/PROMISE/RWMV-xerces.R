...
data <- rbind(ant1, ant2, ant3, ant4, ant5, camel1, camel2, camel3, camel4, jedit1,
              ...
              velocity2, xalan1, xalan2, xalan3, xalan4)
...
# Ploting
##############################################
diverse10 <- c(0.8544,0.8439,0.8431,0.8431,0.8431,0.8431,0.8431,0.8431,0.8431)
diverse20 <- c(0.8701,0.8671,0.8671,0.8671,0.8671,0.8671,0.8671,0.8671,0.8671)
diverse30 <- c(0.8737,0.8597,0.8597,0.8597,0.8597,0.8597,0.8597,0.8597,0.8597)
diverse40 <- c(0.8764,0.875,0.875,0.875,0.875,0.875,0.875,0.875,0.875)
diverse50 <- c(0.8886,0.8836,0.8836,0.8836,0.8836,0.8836,0.8836,0.8836,0.8836)
diverse60 <- c(0.8919,0.8852,0.8919,0.8836,0.8836,0.8836,0.8836,0.8836,0.8836)

png(file = "Xerces.jpg")
# Plot the bar chart.
plot(diverse10, type = "o",col = "red", xlab = "β Values", ylab = "F-Measure Values",
     ylim=c(0.83,0.91), lwd = 2)
