...
setwd('cloud/project/PROMISE/')
data <- rbind(ant1, ant2, ant3, ant4, ant5,
...
# Ploting
##############################################
diverse10 <- c(0.8631,0.8671,0.8629,0.8624,0.8628,0.8625,0.8625,0.8625,0.8625)
diverse20 <- c(0.8371,0.8588,0.8728,0.8728,0.8728,0.8687,0.8623,0.8623,0.8623)
diverse30 <- c(0.8435,0.8636,0.8442,0.8843,0.8443,0.8423,0.8397,0.8402,0.8391)
diverse40 <- c(0.8497,0.8697,0.8712,0.8821,0.8442,0.8481,0.8515,0.8432,0.8391)
diverse50 <- c(0.8557,0.8811,0.8557,0.8514,0.8611,0.8533,0.8533,0.8533,0.8533)
diverse60 <- c(0.8864,0.8717,0.8629,0.8626,0.8509,0.8541,0.8355,0.8355,0.8355)

png(file = "Camel.jpg")
# Plot the bar chart.
plot(diverse10, type = "o",col = "red", xlab = "β Values", ylab = "F-Measure Values",
     ylim=c(0.83,0.90), lwd = 2)
