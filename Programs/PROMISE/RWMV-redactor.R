...
data <- rbind(ant1, ant2, ant3, ant4, ant5, camel1, camel2, camel3, camel4,
              jedit1, jedit2, jedit3, jedit4, jedit5,
              log4j1, log4j2, log4j3, poi1, poi2, 
              poi3, poi4, synapse1, synapse2, synapse3, tomcat, velocity1,
...
# Ploting
##############################################
diverse10 <- c(0.9302,0.9302,0.9302,0.9302,0.9302,0.9302,0.9302,0.9302,0.9302)
diverse20 <- c(0.8859,0.8704,0.8684,0.858,0.8543,0.8543,0.8543,0.8543,0.8543)
diverse30 <- c(0.866,0.861,0.861,0.861,0.861,0.861,0.861,0.861,0.861)
diverse40 <- c(0.8707,0.862,0.8659,0.8561,0.8493,0.8493,0.8493,0.8493,0.8493)
diverse50 <- c(0.9173,0.8881,0.8885,0.8852,0.8852,0.8852,0.8852,0.8852,0.8852)
diverse60 <- c(0.9261,0.9196,0.9196,0.9196,0.9196,0.9196,0.9196,0.9196,0.9196)

png(file = "Redaktor.jpg")
# Plot the bar chart.
plot(diverse10, type = "o",col = "red", xlab = "β Values", ylab = "F-Measure Values",
     ylim=c(0.84,0.98), lwd = 2)
