...
# Data Fusion:
#############################################
NASA <- rbind(CM1,JM1,MC1,MC2,MW1,PC1,PC2,PC3,PC4,PC5)
NASA <- na.omit(NASA)
...
# Ploting
##############################################
diverse10 <- c(0.8047,0.8038,0.8036,0.8036,0.8036,0.8036,0.8036,0.8036,0.8036)
diverse20 <- c(0.7945,0.7654,0.7635,0.7863,0.7632,0.7632,0.7632,0.7632,0.7632)
diverse30 <- c(0.9086,0.9086,0.9086,0.9086,0.9086,0.9086,0.9086,0.9086,0.9086)
diverse40 <- c(0.9162,0.9061,0.9035,0.9035,0.9035,0.9035,0.9035,0.9035,0.9035)
diverse50 <- c(0.8,0.816,0.816,0.816,0.816,0.816,0.816,0.816,0.816)
diverse60 <- c(0.8161,0.816,0.816,0.816,0.816,0.816,0.816,0.816,0.816)

png(file = "KC.jpg")
# Plot the bar chart.
plot(diverse10, type = "o",col = "red", xlab = "β Values", ylab = "F-Measure Values",
     ylim=c(0.75,0.86), lwd = 2)
