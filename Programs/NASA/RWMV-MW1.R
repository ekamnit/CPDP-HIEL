...
# Data Fusion:
#############################################
NASA <- rbind(CM1,JM1,KC1,KC3,MC1,MC2,PC1,PC2,PC3,PC4,PC5)
NASA <- na.omit(NASA)
...
# Ploting
##############################################
diverse10 <- c(0.8641,0.8559,0.8549,0.8549,0.8549,0.8549,0.8549,0.8549,0.8549)
diverse20 <- c(0.8779,0.8642,0.8619,0.8619,0.8619,0.8619,0.8619,0.8619,0.8619)
diverse30 <- c(0.9518,0.948,0.948,0.948,0.948,0.948,0.948,0.948,0.948)
diverse40 <- c(0.9498,0.948,0.948,0.948,0.948,0.948,0.948,0.948,0.948)
diverse50 <- c(0.8788,0.8679,0.8657,0.8657,0.8657,0.8657,0.8657,0.8657,0.8657)
diverse60 <- c(0.8855,0.8591,0.8591,0.8591,0.8591,0.8591,0.8591,0.8591,0.8591)

png(file = "MW.jpg")
# Plot the bar chart.
plot(diverse10, type = "o",col = "red", xlab = "β Values", ylab = "F-Measure Values",
     ylim=c(0.85,0.999), lwd = 2)
