...
# Data Fusion:
#############################################
NASA <- rbind(CM1,JM1,KC1,KC3,MW1,PC1,PC2,PC3,PC4,PC5)
NASA <- na.omit(NASA)
...
# Ploting
##############################################
diverse10 <- c(0.9961,0.9951,0.9952,0.9952,0.9952,0.9952,0.9952,0.9952,0.9952)
diverse20 <- c(0.9963,0.9962,0.9962,0.9962,0.9962,0.9962,0.9962,0.9962,0.9962)
diverse30 <- c(0.9959,0.9959,0.9958,0.9958,0.9958,0.9958,0.9958,0.9958,0.9958)
diverse40 <- c(0.9949,0.9949,0.9948,0.9948,0.9948,0.9948,0.9948,0.9948,0.9948)
diverse50 <- c(0.9781,0.9699,0.9678,0.9678,0.9678,0.9656,0.9656,0.9656,0.9656)
diverse60 <- c(0.9848,0.9737,0.9721,0.9847,0.9721,0.8859,0.8828,0.8828,0.8828)
