...
# Data Fusion:
#############################################
NASA <- rbind(CM1,JM1,KC1,KC3,MC1,MC2,MW1)
NASA <- na.omit(NASA)
...
RMVPredictions <- rbind(as.numeric(PredsLR))#,as.numeric(PredsDT))#,as.numeric(PredsKNN))#,
                        #as.numeric(PredsNB))#,as.numeric(PredsSVM-1))
...
# Ploting
##############################################
diverse10 <- c(0.9811,0.9839,0.9841,0.9729,0.9746,0.9768,0.9768,0.9768,0.9768)
diverse20 <- c(0.9749,0.9811,0.984,0.9768,0.9768,0.9697,0.9612,0.9634,0.9644)
diverse30 <- c(0.9815,0.984,0.9838,0.984,0.9834,0.9834,0.9834,0.9834,0.983)
diverse40 <- c(0.9812,0.9789,0.9837,0.9823,0.9731,0.9769,0.9811,0.9828,0.9826)
diverse50 <- c(0.9745,0.9687,0.9687,0.9686,0.9681,0.9645,0.9632,0.9632,0.9632)
diverse60 <- c(0.9946,0.9687,0.9687,0.9687,0.9687,0.9687,0.9687,0.9687,0.9687)
